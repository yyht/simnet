...
from model.representation_model.representation_model import RepresentationModel
from model.man.man import MAN
from model.diin.diin import DIIN
from model.hard_attention.hard_attention import HardAttention
