...
from model.dsmm.match_pyramid import MatchPyramidBaseModel
from model.utils.dsmm.tf_common import metrics
from model.utils.dsmm.tf_common.nn_module import mlp_layer


class DSMM(MatchPyramidBaseModel, ESIMDecAttBaseModel, BCNN):
    def __init__(self, *args, **kargs):
        super(DSMM, self).__init__(*args, **kargs)
    ...
    def _get_matching_features(self):
        with tf.name_scope(self.model_name):
            ...
            with tf.name_scope("word_network"):
                ...
                deep_word = mlp_layer(deep_in_word, fc_type=self.config["fc_type"],
            ...
            #     deep_char = mlp_layer(deep_in_char, fc_type=self.config["fc_type"],
            #                           hidden_units=self.config["fc_hidden_units"],
            #                           dropouts=self.config["fc_dropouts"],
